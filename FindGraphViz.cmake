...
if ( NOT WIN32 )
  ...
  pkg_check_modules( graphviz ${REQUIRED} libgvc libcgraph libcdt )
  if ( graphviz_FOUND )
...
find_path( graphviz_INCLUDE_DIRECTORIES
    ...
    if ( graphviz_INCLUDE_DIRECTORIES AND
      graphviz_GVC_LIBRARY AND graphviz_CDT_LIBRARY AND graphviz_PATHPLAN_LIBRARY AND graphviz_GRAPH_LIBRARY)
      set ( graphviz_FOUND 1 )
      set ( graphviz_LIBRARIES "${graphviz_GVC_LIBRARY};${graphviz_GRAPH_LIBRARY};${graphviz_CDT_LIBRARY};${graphviz_PATHPLAN_LIBRARY}" CACHE FILEPATH "Libraries for graphviz" )
