...
MachinePropertiesDlgImpl::MachinePropertiesDlgImpl( QWidget* parent,  const char* name, bool modal, Qt::WindowFlags fl )
    ...
    machinePropertiesDlg.lbox_arrowtype->addItem(lb1);
    machinePropertiesDlg.lbox_arrowtype->addItem(lb2);
    machinePropertiesDlg.lbox_arrowtype->addItem(lb3);
    machinePropertiesDlg.lbox_arrowtype->addItem(lb4);
    machinePropertiesDlg.lbox_arrowtype->addItem(lb5);
