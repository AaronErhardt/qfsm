...
public:
  ...
  void
  setInputs(QString s); // { transitionPropertiesDlg.le_input->setText(s); };
  ...
  QString getDescription() {
    return transitionPropertiesDlg.te_description->text();
  };
  /// Sets the string of the description field
  void setDescription(QString s) {
    transitionPropertiesDlg.te_description->setText(s);
  };
  ...
  bool getDefaultTransition() {
    return transitionPropertiesDlg.cb_default->isChecked();
  };
  /// Sets the state of the 'default transition' checkbox
  void setDefaultTransition(bool i) {
    transitionPropertiesDlg.cb_default->setChecked(i);
  };
  ...
  void selectFirst() {
    transitionPropertiesDlg.le_input->selectAll();
    transitionPropertiesDlg.le_input->setFocus();
  };

  /// Sets the maximum length for the inputs field
  void setInputMaxLength(int l) {
    transitionPropertiesDlg.le_input->setMaxLength(l);
  };
  /// Sets the maximum length for the outputs field
  void setOutputMaxLength(int l) {
    transitionPropertiesDlg.le_output->setMaxLength(l);
  };
