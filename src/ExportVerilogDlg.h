...
public:
  ...
  void setupUi(QDialog *ExportVerilogDlg) {
    ...
    spacerItem =
        new QSpacerItem(48, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    QObject::connect(cb_synchreset, SIGNAL(clicked()), ExportVerilogDlg,
                     SLOT(syncResetClicked()));
    QObject::connect(pb_export, SIGNAL(clicked()), ExportVerilogDlg,
                     SLOT(accept()));
    QObject::connect(pb_cancel, SIGNAL(clicked()), ExportVerilogDlg,
                     SLOT(reject()));
  ...
  void retranslateUi(QDialog *ExportVerilogDlg) {
    ExportVerilogDlg->setWindowTitle(
        QApplication::translate("ExportVerilogDlg", "Verilog Export Options", 0,
                                QApplication::UnicodeUTF8));
    cb_synchreset->setText(QApplication::translate(
        "ExportVerilogDlg", "Synchronous reset", 0, QApplication::UnicodeUTF8));
    pb_export->setText(QApplication::translate("ExportVerilogDlg", "Export", 0,
                                               QApplication::UnicodeUTF8));
    pb_cancel->setText(QApplication::translate("ExportVerilogDlg", "Cancel", 0,
                                               QApplication::UnicodeUTF8));
...
public:
  ExportVerilogDlg(QWidget *parent = 0, const char *name = 0,
