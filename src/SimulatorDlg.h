...
public:
  ...
  void setupUi(QDialog *SimulatorDlg) {
    ...
    sizePolicy.setHeightForWidth(
        SimulatorDlg->sizePolicy().hasHeightForWidth());
    ...
    sizePolicy4.setHeightForWidth(
        ButtonGroup2->sizePolicy().hasHeightForWidth());
    ...
    QObject::connect(pb_clock, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(clockPressed()));
    QObject::connect(le_inputs, SIGNAL(textChanged(QString)), SimulatorDlg,
                     SLOT(inputsChanged(QString)));
    QObject::connect(rb_ibin, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(iBinPressed()));
    QObject::connect(rb_ihex, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(iHexPressed()));
    QObject::connect(rb_iascii, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(iASCIIPressed()));
    QObject::connect(rb_obin, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(oBinPressed()));
    QObject::connect(rb_ohex, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(oHexPressed()));
    QObject::connect(rb_oascii, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(oASCIIPressed()));
    ...
    QObject::connect(pb_cancel, SIGNAL(pressed()), SimulatorDlg,
                     SLOT(closeSim()));
    QObject::connect(pb_bin0, SIGNAL(released()), SimulatorDlg,
                     SLOT(button0Pressed()));
    QObject::connect(pb_bin1, SIGNAL(released()), SimulatorDlg,
                     SLOT(button1Pressed()));
    QObject::connect(pb_bin10, SIGNAL(released()), SimulatorDlg,
                     SLOT(button10Pressed()));
    QObject::connect(pb_bin11, SIGNAL(released()), SimulatorDlg,
                     SLOT(button11Pressed()));
    QObject::connect(pb_bin12, SIGNAL(released()), SimulatorDlg,
                     SLOT(button12Pressed()));
    QObject::connect(pb_bin13, SIGNAL(released()), SimulatorDlg,
                     SLOT(button13Pressed()));
    QObject::connect(pb_bin14, SIGNAL(released()), SimulatorDlg,
                     SLOT(button14Pressed()));
    QObject::connect(pb_bin15, SIGNAL(released()), SimulatorDlg,
                     SLOT(button15Pressed()));
    QObject::connect(pb_bin2, SIGNAL(released()), SimulatorDlg,
                     SLOT(button2Pressed()));
    QObject::connect(pb_bin3, SIGNAL(released()), SimulatorDlg,
                     SLOT(button3Pressed()));
    QObject::connect(pb_bin4, SIGNAL(released()), SimulatorDlg,
                     SLOT(button4Pressed()));
    QObject::connect(pb_bin5, SIGNAL(released()), SimulatorDlg,
                     SLOT(button5Pressed()));
    QObject::connect(pb_bin6, SIGNAL(released()), SimulatorDlg,
                     SLOT(button6Pressed()));
    QObject::connect(pb_bin7, SIGNAL(released()), SimulatorDlg,
                     SLOT(button7Pressed()));
    QObject::connect(pb_bin8, SIGNAL(released()), SimulatorDlg,
                     SLOT(button8Pressed()));
    QObject::connect(pb_bin9, SIGNAL(released()), SimulatorDlg,
                     SLOT(button9Pressed()));
    QObject::connect(le_inputs, SIGNAL(returnPressed()), SimulatorDlg,
                     SLOT(returnPressedInputs()));

    QMetaObject::connectSlotsByName(SimulatorDlg);
  } // setupUi

  void retranslateUi(QDialog *SimulatorDlg) {
    SimulatorDlg->setWindowTitle(QApplication::translate(
        "SimulatorDlg", "Simulator", 0, QApplication::UnicodeUTF8));
    GroupBox3->setTitle(QApplication::translate("SimulatorDlg", "Inputs", 0,
                                                QApplication::UnicodeUTF8));
    ButtonGroup1->setTitle(QString());
    rb_ibin->setText(QApplication::translate("SimulatorDlg", "Binary", 0,
                                             QApplication::UnicodeUTF8));
    rb_ihex->setText(QApplication::translate("SimulatorDlg", "Hexadecimal", 0,
                                             QApplication::UnicodeUTF8));
    rb_iascii->setText(QApplication::translate("SimulatorDlg", "ASCII", 0,
                                               QApplication::UnicodeUTF8));
    pb_bin15->setText(QApplication::translate("SimulatorDlg", "15", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin14->setText(QApplication::translate("SimulatorDlg", "14", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin13->setText(QApplication::translate("SimulatorDlg", "13", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin12->setText(QApplication::translate("SimulatorDlg", "12", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin11->setText(QApplication::translate("SimulatorDlg", "11", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin10->setText(QApplication::translate("SimulatorDlg", "10", 0,
                                              QApplication::UnicodeUTF8));
    pb_bin9->setText(QApplication::translate("SimulatorDlg", "9", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin8->setText(QApplication::translate("SimulatorDlg", "8", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin7->setText(QApplication::translate("SimulatorDlg", "7", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin6->setText(QApplication::translate("SimulatorDlg", "6", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin5->setText(QApplication::translate("SimulatorDlg", "5", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin4->setText(QApplication::translate("SimulatorDlg", "4", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin3->setText(QApplication::translate("SimulatorDlg", "3", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin2->setText(QApplication::translate("SimulatorDlg", "2", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin1->setText(QApplication::translate("SimulatorDlg", "1", 0,
                                             QApplication::UnicodeUTF8));
    pb_bin0->setText(QApplication::translate("SimulatorDlg", "0", 0,
                                             QApplication::UnicodeUTF8));
    GroupBox4->setTitle(QApplication::translate("SimulatorDlg", "Outputs", 0,
                                                QApplication::UnicodeUTF8));
    lb_outputs->setText(QString());
    ButtonGroup2->setTitle(QString());
    rb_obin->setText(QApplication::translate("SimulatorDlg", "Binary", 0,
                                             QApplication::UnicodeUTF8));
    rb_ohex->setText(QApplication::translate("SimulatorDlg", "Hexadecimal", 0,
                                             QApplication::UnicodeUTF8));
    rb_oascii->setText(QApplication::translate("SimulatorDlg", "ASCII", 0,
                                               QApplication::UnicodeUTF8));
    TextLabel1->setText(QApplication::translate(
        "SimulatorDlg", "State Name:", 0, QApplication::UnicodeUTF8));
    lb_sname->setText(QString());
    TextLabel3->setText(QApplication::translate(
        "SimulatorDlg", "State Code:", 0, QApplication::UnicodeUTF8));
    lb_scode->setText(QString());
    pb_clock->setText(QApplication::translate("SimulatorDlg", "Clock", 0,
                                              QApplication::UnicodeUTF8));
    lb_frequency->setText(QApplication::translate(
        "SimulatorDlg", "Frequency:", 0, QApplication::UnicodeUTF8));
    pb_send->setText(QApplication::translate("SimulatorDlg", "Send", 0,
                                             QApplication::UnicodeUTF8));
    pb_reset->setText(QApplication::translate("SimulatorDlg", "Reset", 0,
                                              QApplication::UnicodeUTF8));
    pb_cancel->setText(QApplication::translate("SimulatorDlg", "Cancel", 0,
                                               QApplication::UnicodeUTF8));
  } // retranslateUi
};
