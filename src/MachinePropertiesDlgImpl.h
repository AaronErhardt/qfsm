...
public:
  ...
  int getArrowType() {
    return machinePropertiesDlg.lbox_arrowtype->currentItem();
  };
  /// Sets the arrow type used for the transitions
  void setArrowType(int at) {
    machinePropertiesDlg.lbox_arrowtype->setCurrentItem(at);
  };
  /// Returns the string of the desription field
  QString getDescription() {
    return machinePropertiesDlg.te_description->text();
  };
