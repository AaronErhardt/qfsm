...
public:
  ...
  QString getDescription() {
    return statePropertiesDlg.te_description->text();
  };
  /// Sets the string of the description field
  void setDescription(QString s) {
    statePropertiesDlg.te_description->setText(s);
  };
  /// Returns the code
  ...
  QString getMooreOutputs() {
    return statePropertiesDlg.le_mooreoutputs->text();
  };
  /// Sets the moore outputs
  void setMooreOutputs(const QString &s) {
    statePropertiesDlg.le_mooreoutputs->setText(s);
  };
  ...
  void setEntryActions(const QString &s) {
    statePropertiesDlg.le_entry->setText(s);
  };
  ...
  void setMooreOutputsMaxLength(int l) {
    statePropertiesDlg.le_mooreoutputs->setMaxLength(l);
  };
  /// Sets the maximum length of the entry actions
  void setEntryMaxLength(int l) {
    statePropertiesDlg.le_entry->setMaxLength(l);
  };
  ...
  void selectFirst() {
    statePropertiesDlg.le_name->selectAll();
    statePropertiesDlg.le_name->setFocus();
  };
